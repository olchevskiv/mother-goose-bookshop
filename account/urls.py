...
urlpatterns = [
    ...
    path('password_reset/', auth_views.PasswordResetView.as_view(template_name='account/user/password_reset_form.html', success_url='/account/password_reset_email_confirm/', email_template_name='account/user/password_reset_email.html', form_class=PasswordResetForm), name='password_reset'),
    ...
    path('password_reset_email_confirm/',
